...
//    Birds* bird1 = new Birds("Black",5,12,60);
//    Fish* fish1 = new Fish("Blue",7,7,7,7);
//    Flamingo* flam1 = new Flamingo("Silver",4,4,4,4);
//    GoldFish* goldf1 = new GoldFish("Gold",12,12,12,12,12,12,12,12);
//    Horse* horse1 = new Horse();
//    Mermaid* merm1 = new Mermaid("Pink",10,20,9.5,5,4,4,"Ariel","Levi");
//    GoldFish* goldf2(goldf1);
{
